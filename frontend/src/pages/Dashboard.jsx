...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      {announcements.length > 0 && (
        <div className="card mb-8">
          <h2 className="text-xl font-semibold mb-4 flex items-center space-x-2">
            <Bell className="w-5 h-5 text-islamic-600" />
              ...
              <div key={announcement.id} className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-2">{announcement.content.substring(0, 100)}{announcement.content.length > 100 ? '...' : ''}</p>
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs ${announcement.category === 'RELIGIOUS' ? 'bg-islamic-100 text-islamic-800' :
      ...
      <div className="card">
        <h2 className="text-xl font-semibold mb-4">Selamat Datang di Sistem Akademik Cahaya Ilmu</h2>
        ...
        <div className="p-4 bg-islamic-50 rounded-lg border border-islamic-200">
          <h3 className="font-semibold text-islamic-800 mb-2">Fitur Utama</h3>
